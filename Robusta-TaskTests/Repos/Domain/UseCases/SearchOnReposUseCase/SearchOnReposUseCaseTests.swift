//
//  SearchOnReposUseCaseTests.swift
//  Robusta-TaskTests
//
...
final class SearchOnReposUseCaseTests: XCTestCase {
    
    // MARK: - PROPERTIES
    private var sut: SearchOnReposUseCase!
    ...
    func testSUT_whenExecutingUseCaseCorrectly_validResponseReturned() {
        ...
        let sut = SearchOnReposUseCase(repository: validRepository)
    ...
    func testSUT_whenExecutingUseCaseIncorrectly_invalidResponseReturned() {
        ...
        let sut = SearchOnReposUseCase(repository: inValidRepository)
